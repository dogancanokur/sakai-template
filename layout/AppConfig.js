                ...
                {!props.simple && (
                    <>
                        ...
                        <div className="flex">
                            ...
                            <div className="field-radiobutton flex-1">
                                <RadioButton name="menuMode" value={'sidebar'}
                                             checked={layoutConfig.menuMode === 'sidebar'}
                                             onChange={(e) => changeMenuMode(e)} inputId="mode3"></RadioButton>
                                <label htmlFor="mode3">Sidebar</label>
                            </div>
                        </div>
